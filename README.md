...
这是我练习修改的仿真项目文档 **人** 和 **载具**（[具身人](https://openhutb.github.io/doc/#_5)、[地面载具](https://openhutb.github.io/doc/#_4)、[空域载具](https://openhutb.github.io/air_doc/)、[水域载具](https://openhutb.github.io/mujoco_plugin/underwater/)）的 **影视级物理模拟器**，旨在加速人和机器人的算法开发、训练和验证。
